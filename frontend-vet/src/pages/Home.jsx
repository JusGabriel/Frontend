    ...
    <header className="sticky top-0 z-50 bg-[#1E1E2F] border-b border-[#F7E5D2] shadow-sm">
      <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <nav className="flex items-center gap-4">
          <Link to="/login" className="inline-block bg-[#AA4A44] text-white px-6 py-3 rounded-md font-semibold shadow-sm hover:bg-[#933834] transition-colors">Iniciar sesión</Link>
